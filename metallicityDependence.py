...
ax.plot(metallicityCutoffs, GGMetalRichEnhancement, ls = "", marker = "o", label = "[Fe/H] > x, GG Inner")
ax.plot(metallicityCutoffs, GGMetalPoorEnhancement, ls = "", marker = "o", label = "[Fe/H] <= x, GG Inner")
