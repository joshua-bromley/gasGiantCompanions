...
sb.kdeplot(x = betaResults[:,0], y = betaResults[:,1], ax = ax, fill = True)
sb.kdeplot(x = betaResults[:,2], y = betaResults[:,3], ax = ax, fill = True)
sb.kdeplot(x = betaResults[:,4], y = betaResults[:,5], ax = ax, fill = True)
sb.kdeplot(x = betaResults[:,6], y = betaResults[:,7], ax = ax, fill = True)
ax.set_xlabel("$\\alpha$")
ax.set_ylabel("$\\beta$")
...
fig, ax = plt.subplots(1,1)
sb.kdeplot(x = rayleighResults[:,0], y = rayleighResults[:,1], ax = ax, fill = True)
sb.kdeplot(x = rayleighResults[:,2], y = rayleighResults[:,3], ax = ax, fill = True)
sb.kdeplot(x = rayleighResults[:,4], y = rayleighResults[:,5], ax = ax, fill = True)
sb.kdeplot(x = rayleighResults[:,6], y = rayleighResults[:,7], ax = ax, fill = True)
ax.set_xlabel("loc")
ax.set_ylabel("$\sigma$")
ax.plot(-10,-10, ls = "", marker = ".", color = "tab:blue", label = "All Gas Giants")
ax.plot(-10,-10, ls = "", marker = ".", color = "tab:orange", label = "SE Companions")
