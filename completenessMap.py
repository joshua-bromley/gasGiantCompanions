...
def complete_maps():
    ...
    for x in range(129,len(sys)):
        ...
        #CoRoT24
        if plname == "CoRoT24" or plname == "Kepler539" or plname == "HIP65407" or plname == "HD219828" or plname == "HD160691" or plname == "HD141399" or plname == "HD113538" or plname == "WASP89" or plname == "WASP81" or plname == "WASP80" or plname == "WASP74" or plname == "WASP66" or plname == "WASP62" or plname == "WASP60" or plname == "WASP5" or plname == 'WASP22' or plname == "TYC4282006051":
            time, rv, err = np.loadtxt(f"./RVData/rv{plname}.txt", delimiter=",", usecols = (0,1,2)).T
            time = time-50000
            rv = rv*1000
            err = err*1000
