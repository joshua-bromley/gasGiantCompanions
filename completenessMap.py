...
def complete_maps():
    ...
    for x in range(305,len(sys)):
        ...
        if plname == "Kepler93" or plname == "Kepler94" or plname == "Kepler68" or plname == "Kepler48" or plname == "Kepler454" or plname == "Kepler407" or plname == "KELT6" or plname == "HIP8541" or plname == "HD80653" or plname == "HD67087" or plname == "HD47366" or plname == "HD155358" or plname == "HD134987" or plname == "HATS59" or plname == "HATP2" or plname == "75Cet" or plname == "xiAql" or plname == "tauBoo" or plname == "omeSer" or plname == "HIP75092" or plname == "HIP74890" or plname == "HIP114933" or plname == "HD158996" or plname == "HD14067" or plname == "HD110014" or plname == "HATS68" or plname == "HATS64" or plname == "HATS62" or plname == "HATS27":
            time, rv, err = np.loadtxt(f"./RVData/rv{plname}.txt", delimiter=",", usecols = (0,1,2)).T
