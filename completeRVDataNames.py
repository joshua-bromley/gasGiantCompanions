...
otherSource = systemData[(pd.isna(systemData["data_ref"]) == False) & (systemData["data_ref"] != "Rosenthal+21") & (systemData["prop_ref"] != "Bonomo+17") & (systemData["data_ref"] != "Bonomo+17") & (systemData["data_ref"] != "Bonomo+23") & (systemData["data_ref"] != "Weiss+24")]
